		...
		<project default="all" basedir="..">
			...
			<target name="catalog">
				<xmlcatalog id="log-dtds">
					...
					<dtd location="log_1_5.dtd"
					     publicId="-//XINS//DTD XINS Logdoc 1.5//EN" />
					<dtd location="translation-bundle_1_5.dtd"
					     publicId="-//XINS//DTD XINS Translation Bundle 1.5//EN" />

					<dtd location="log_2_0.dtd"
					...
					<dtd location="log_2_2.dtd"
					     publicId="-//XINS//DTD XINS Logdoc 2.2//EN" />
					<dtd location="translation-bundle_2_2.dtd"
					     publicId="-//XINS//DTD XINS Translation Bundle 2.2//EN" />

					<dtd location="log_2_3.dtd"
					     publicId="-//XINS//DTD XINS Logdoc 2.3//EN" />
					<dtd location="translation-bundle_2_3.dtd"
					     publicId="-//XINS//DTD XINS Translation Bundle 2.3//EN" />
				</xmlcatalog>
