 ...
 * versa, specifically for Logdoc classes.
 *
 * @version $Revision$ $Date$
 * @author <a href="mailto:ernst@ernstdehaan.com">Ernst de Haan</a>
 *
 * @since XINS 1.0.0
 * @deprecated since XINS 2.0, never used.
 */
public class LogdocHexConverter {
    ...
    */
   public static void toHexString(LogdocStringBuffer buffer, int n)
   throws IllegalArgumentException {
    ...
    *    if <code>buffer == null</code>.
    */
   public static void toHexString(LogdocStringBuffer buffer, long n)
   throws IllegalArgumentException {
