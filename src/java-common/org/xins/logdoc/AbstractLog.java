...
public abstract class AbstractLog {
   ...
   static {
      ...
      if (noticeInt <= Level.INFO_INT || noticeInt >= Level.WARN_INT) {
         throw new ProgrammingError("Unable to determine int value for NOTICE level between INFO and WARN. Value for INFO level is " + Level.INFO_INT + ". Value for WARN level is " + Level.WARN_INT + '.');
      }
