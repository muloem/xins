   ...
   throws QueueTimeOutException {
      ...
      synchronized (_currentActorLock) {
         ...
         if (_currentWriter == reader) {
            ...
            Log.log_3050(DOORMAN_CLASSNAME, "enterAsReader()", message);
            if (_strict) {
   ...
   throws QueueTimeOutException {
      ...
      synchronized (_currentActorLock) {
         ...
         if (_currentWriter == writer) {
            ...
            Log.log_3050(DOORMAN_CLASSNAME, "enterAsWriter()", message);
            if (_strict) {
               throw new Error(message);
            } else {
   ...
   public void leaveAsReader() {
      ...
      synchronized (_currentActorLock) {
         ...
         if (!readerRemoved) {
            ...
            Log.log_3050(DOORMAN_CLASSNAME, "leaveAsReader()", message);
            if (_strict) {
               throw new Error(message);
            } else {
   ...
   public void leaveAsWriter() {
      ...
      synchronized (_currentActorLock) {
         ...
         if (_currentWriter != writer) {
            ...
            Log.log_3050(DOORMAN_CLASSNAME, "leaveAsWriter()", message);
            if (_strict) {
               throw new Error(message);
            } else {
   ...
   extends Object {
      ...
      throws Error {
         ...
         if (_entryTypes.containsKey(thread)) {
            ...
            Log.log_3050(DOORMAN_CLASSNAME, "add(Thread,QueueEntryType)", message);
            throw new Error(message);
         }
      ...
      public Thread pop() throws Error {
         ...
         if (_first == null) {
            ...
            Log.log_3050(DOORMAN_CLASSNAME, "pop()", message);
            throw new Error(message);
         }
      ...
      throws Error {
         ...
         if (thread == _first) {
            ...
            if (! _entries.remove(thread)) {
               ...
               Log.log_3050(DOORMAN_CLASSNAME, "remove(Thread)", message);
               throw new Error(message);
            }
         }
