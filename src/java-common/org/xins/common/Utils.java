...
public final class Utils extends Object {
   ...
   private static final void traceMethod(boolean enter, Object detail) {
      ...
      // Actually log
      if (enter) {
         Log.log_1003(callingClass, callingMethod, detailString);
      } else {
         Log.log_1005(callingClass, callingMethod, detailString);
      }
   }
    ...
    * @since XINS 1.2.0
    */
   public static final void traceEnterMethod() {
    ...
    * @since XINS 1.2.0
    */
   public static final void traceEnterMethod(Object detail) {
    ...
    * @since XINS 1.2.0
    */
   public static final void traceLeaveMethod() {
    ...
    * @since XINS 1.2.0
    */
   public static final void traceLeaveMethod(Object detail) {
